  ...
  <section class="bodyContain">
      ...
      <section class="content">
            <div class="receiverInfo">
                ...
                <div class="addr">
                    广东省广州市番禺区大学城广东工业大学下一站广东省广州市海珠赤岗分拣
                </div>
            </div>
            <div class="rule"></div>
            <div class="expressProgress">
                 <h3>物流状态</h3>
                 <div class="express">顺丰速运</div>
                 <div class="statusInfo">
                    <ul>
                        <li>
                            <div class="info">[广州运转中心]已发出，下一站广东省广州市海珠赤岗分拣站下一站广东省广州市海珠赤岗分拣站</div>
                            <div class="date">2016-01-25  15:26:20</div>
                        </li>
                        <li>
                            <div class="info">[广州运转中心]已发出，下一站广东省广州市海珠赤岗分拣站</div>
                            <div class="date">2016-01-25  15:26:20</div>
                        </li>                     
                    </ul>
                 </div>
            ...
            <div class="orderStatus">
                <div>
                    <span>状态：</span>
                     <span style="color:#e6186f">待收货</span>
                </div>
                <div>
                    <span>支付方式：</span>
                    <span>微信支付</span>
                ...
                <div>
                    <span>订单编号：</span>
                    <span>1324234234324</span>
                </div>
                <div>
                    <span>下单时间：</span>
                    <span>2017-8-8 12:23:00</span>
                </div>
                <button>确认收货</button>
            </div>
            <div class="orderInfo">
                ...
                <div class="note">备注：<span>无</span></div>
            </div>
            <div class="total">
                <ul>
                    <li>
                ...
                <div class="totalPrice">实付总额：<span>0.00</span></div>
            </div>
      </section>
  </section>
</template>
...
$red: #e6186f;
$borderGrey: #cdd3ce;
$imgSrc: "/src/assets/images/orderDetail/";
.content {
  .receiverInfo {
  ...
  .rule {
    width: 7.5rem;
    height: 0.05rem;
    background: url($imgSrc + "borderImg.png") repeat;
  }
  .expressProgress {
    margin-top: 0.2rem;
    padding: 0.2rem 0;
    ...
    .statusInfo {
      ...
      ul {
        ...
        li {
          position: relative;
          &:first-child:before {
            background-color: #0bb92c;
            border: 0.04rem solid #adffca;
            left: -0.39rem;
          }
          &:before {
            content: "";
