        ...
        <section class="content">
            <div class="inputBox">
                ...
                <input type="text" placeholder="">
                 <svg version="1.1" baseProfile="full" width="0.37rem" height="0.37rem" xmlns="http://www.w3.org/2000/svg">
                    <circle cx="0.185rem" cy="0.175rem" r="0.175rem" stroke-width="0.03rem" stroke="grey" fill="white" />
                    <line x1="0.06rem" x2="0.21rem" y1="0.06rem" y2="0.21rem" stroke="grey" stroke-width="0.04rem" />
                    <line x1="0.21rem" x2="0.06rem" y1="0.06rem" y2="0.21rem" stroke="grey" stroke-width="0.04rem" />
                </svg>                
            </div>
        </section>
   </section>
